...
const FounderSection = () => {
  return (
    <section className="py-20 bg-gradient-to-br from-mokm-orange-50 via-mokm-pink-50 to-mokm-purple-50">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <h3 className="text-2xl font-semibold bg-gradient-to-r from-mokm-orange-500 via-mokm-pink-500 to-mokm-blue-500 bg-clip-text text-transparent">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <p className="font-semibold bg-gradient-to-r from-mokm-purple-500 via-mokm-blue-500 to-mokm-orange-500 bg-clip-text text-transparent">
          ...
          <div className="relative">
            <div className="relative w-full max-w-md mx-auto">
              <div className="absolute inset-0 bg-gradient-to-br from-mokm-orange-400 via-mokm-pink-400 to-mokm-blue-500 rounded-2xl transform rotate-6"></div>
